        ...
        <div className={styles.project}>
            ...
            <div className={styles.projectImageRow}>
                <div className={styles.projectRowCol}>
                    <Image src={iVariHRMSHome} alt="Home Page" width={500} height={300} />
                    <Image src={iVariHRMSPunchIn} alt="Punch In Page" width={500} height={300} />
                    <Image src={iVariHRMSLeave} alt="Leave Page" width={500} height={300} />
                    <Image src={iVariHRMSSales} alt="Sales Page" width={500} height={300} />
                    <Image src={iVariHRMSSalary} alt="Salary Page" width={500} height={300} />
                    <Image src={iVariHRMSOutReach} alt="Outreach Page" width={500} height={300} />
                </div>
                <div className={styles.projectRowCol}>
                    <Image src={iVariHRMSDashboard} alt="Dashboard" width={500} height={300} />
                    <Image src={iVariHRMSAttendance} alt="Attendance" width={500} height={300} />
                    <Image src={iVariHRMSDashboardLeave} alt="Dashboard Leave" width={500} height={300} />
                    <Image src={iVariHRMSDashboardSales} alt="Dashboard Sales" width={500} height={300} />
                    <Image src={iVariHRMSDashboardSalary} alt="Dashboard Salary" width={500} height={300} />
                    <Image src={iVariHRMSDashboardOutReach} alt="Dashboard Outreach" width={500} height={300} />
                </div>
            </div>
